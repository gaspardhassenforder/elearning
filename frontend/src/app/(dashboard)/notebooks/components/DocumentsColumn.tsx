...
export function DocumentsColumn({
  ...
  const collapseButton = useMemo(
    () => createCollapseButton(toggleSources, t.navigation.documents),
    [toggleSources, t.navigation.documents]
  )
  ...
  return (
    <>
      <CollapsibleColumn
        ...
        collapsedLabel={t.navigation.documents}
      >
        <Card className="h-full flex flex-col flex-1 overflow-hidden">
          <CardHeader className="pb-3 flex-shrink-0">
            <div className="flex items-center justify-between gap-2">
              <CardTitle className="text-lg">{t.navigation.documents}</CardTitle>
