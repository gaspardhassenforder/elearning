export const frFR = {
  ...
  users: {
    ...
    confirmDeleteDesc: "Cette action ne peut pas être annulée. L'utilisateur sera définitivement supprimé.",
    newPassword: "Nouveau mot de passe",
    leaveBlankToKeepCurrent: "Laisser vide pour conserver le mot de passe actuel",
    editUser: "Modifier l'utilisateur",
    createNewUser: "Créer un nouvel utilisateur",
    noUsers: "Aucun utilisateur pour le moment",
    noUsersDesc: "Créez votre premier utilisateur pour commencer.",
  ...
  companies: {
    ...
    noCompanies: "Aucune entreprise pour le moment",
    noCompaniesDesc: "Créez votre première entreprise pour commencer.",
    confirmDelete: "Êtes-vous sûr de vouloir supprimer cette entreprise ?",
    confirmDeleteDesc: "Cette action ne peut pas être annulée. L'entreprise et toutes les données associées seront définitivement supprimées.",
    cannotDeleteWithUsers: "Impossible de supprimer une entreprise avec des utilisateurs assignés",
    cannotDeleteWithUsersDesc: "Réassignez ou supprimez tous les utilisateurs de cette entreprise avant de la supprimer.",
    editCompany: "Modifier l'entreprise",
    ...
    slugAutoGenerated: "Généré automatiquement à partir du nom si laissé vide",
    members: "{count} membres",
    assignments: "{count} affectations de module",
  },
}
