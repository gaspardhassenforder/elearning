export const frFR = {
  ...
  podcasts: {
    ...
    templatesWorkspaceDesc: "Configurez les types d'épisode podcast : intervenants, consigne et nombre de segments. La TTS et les modèles de script sont fixés pour ce déploiement (Google).",
    howTemplatesPowerTitle: "Fonctionnement des modèles podcast",
    howTemplatesPowerDesc: "Chaque modèle enregistre le format d'épisode, la consigne par défaut et un à quatre intervenants avec des voix Google TTS. La génération audio et script utilise les réglages serveur.",
    howTemplatesGoogleVoicesTitle: "Noms de voix Google (Kore, Puck, Charon, Aoede)",
    howTemplatesGoogleVoicesIntro:
      "Ces quatre choix sont des identifiants prédéfinis pour la TTS Google multilingue : ce ne sont pas des « types » techniques (comme genre ou code langue). Les noms reprennent la mythologie et la littérature ; chacun correspond à une persona au timbre différent. Pour le rendu exact à l’écoute, consultez la documentation Google ou les démos audio TTS.",
    howTemplatesGoogleVoiceKore:
      "Kore — Référence gréco-latine ; persona souvent plus douce et claire dans la gamme Google.",
    howTemplatesGoogleVoicePuck:
      "Puck — Folklore et Shakespeare ; ton souvent plus léger et enjoué.",
    howTemplatesGoogleVoiceCharon:
      "Charon — Mythologie grecque ; timbre souvent plus grave et posé.",
    howTemplatesGoogleVoiceAoede:
      "Aoede — Une des Muses (chant, mélodie) ; souvent adaptée à une diction type narration.",
    episodeProfilesSetFormat: "Ce que vous configurez",
    episodeProfilesList1: "Nom du modèle, description et nombre de segments",
    episodeProfilesList2: "Consigne par défaut (ton, structure, objectifs pédagogiques)",
    episodeProfilesList3: "Intervenants : nom affiché, voix Google, histoire et personnalité",
    speakerProfilesBringVoices: "En coulisses",
    speakerProfilesList1: "Un pack voix lié est créé automatiquement pour chaque modèle",
    speakerProfilesList2: "Dupliquer un modèle copie les intervenants pour les modifier séparément",
    speakerProfilesList3: "Les anciens modèles partageant un pack voix restent valides ; les modifier met à jour ce pack partagé",
    recommendedWorkflow: "Démarrage rapide",
    workflowStep1: "Créez un modèle avec « Créer un profil »",
    workflowStep2: "Ajoutez des intervenants avec « Ajouter un intervenant » et choisissez une voix Google par rôle",
    workflowStep3: "Utilisez le modèle lors de la génération d'un podcast depuis un notebook",
    workflowHint: "Supprimer un modèle retire aussi son pack voix dédié s'il a été créé avec cet assistant.",
    unifiedPodcastWizardDesc: "Définissez le format d'épisode et les intervenants. La TTS et les modèles outline/transcript sont appliqués par le serveur.",
    unifiedLoadSpeakerErrorTitle: "Impossible de charger les intervenants",
    unifiedLoadSpeakerErrorDesc: "Le pack voix lié à ce modèle est introuvable. Vérifiez l'API ou la base de données.",
    unifiedLoadingSpeakers: "Chargement de la configuration des intervenants…",
    unifiedEngineNote:
      "La TTS Google multilingue et les modèles Gemini pour outline/transcript sont fixés côté serveur ; vous ne les choisissez pas ici.",
    unifiedSpeakersDesc: "Choisissez une voix Google prédéfinie pour chaque rôle (TTS multilingue).",
    googleVoiceLabel: "Voix Google",
    googleVoicePlaceholder: "Choisir une voix",
    ...
    episodeProfilesDesc: "Un assistant par modèle : intervenants, consigne et segments. TTS et modèles de script sont côté serveur.",
