export const zhCN = {
  ...
  apiErrors: {
    ...
    noDefaultModel: "未配置默认聊天模型。请前往 设置 → 模型 配置默认聊天模型。",
  ...
  artifacts: {
    ...
    generateQuizDesc: "从您的笔记本来源创建测验",
    noArtifacts: "还没有作品",
    noArtifactsDescription: "生成测验或播客以开始",
    quiz: "测验",
    podcast: "播客",
    transformation: "转换",
    all: "全部",
    ...
    quizTopic: "主题（可选）",
    quizTopicPlaceholder: "例如：JavaScript 数组",
    numQuestions: "问题数量",
    generating: "生成中...",
    question: "问题",
    submit: "提交",
