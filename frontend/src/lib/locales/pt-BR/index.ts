export const ptBR = {
  ...
  apiErrors: {
    ...
    noAnswerGenerated: "Não foi possível gerar resposta",
    noDefaultModel: "Nenhum modelo de chat padrão configurado. Por favor, vá em Configurações → Modelos e configure um modelo de chat padrão.",
    finalAnswerModelNotFound: "Modelo de resposta final não encontrado",
